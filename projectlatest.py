...
def run():
    ...
    def documentation():
        ...
        lb717=Label(obj7,text='16. For any bugs and queries contact ,email us on singhdsdeepak393@gmail.com ',font=('arial',13,'bold'),fg='blue' ,bg='black')
        ...
        lb717=Label(obj7,text='Powered BY ',font=('arial',10,'bold'),fg='blue' ,bg='black')
